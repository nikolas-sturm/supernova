/**
 * @file src/eclipse_operations.h
 * @brief Thread-safe Eclipse V1 operations and idempotency storage.
 */
#pragma once
...
/**
 * @brief Eclipse V1 asynchronous operation storage.
 */
namespace eclipse_operations {
  ...
  /**
   * @brief Stored Eclipse operation.
   */
  struct operation_t {
  ...
  /**
   * @brief Serialize an operation for Eclipse API responses.
   *
