...
namespace eclipse_api {
  ...
  constexpr std::array<std::string_view, 13> KNOWN_CAPABILITIES {
    ...
    "sandboxes-v1",
    "discovery-v1",
  };  ///< Stable Eclipse API capability names, including unavailable features.
  ...
  constexpr std::array<std::string_view, 8> CAPABILITIES {
    ...
    "workspaces-v1",
    "telemetry-v1",
  };  ///< Eclipse API capabilities currently implemented by this host.
  ...
  constexpr std::array<std::string_view, 5> INPUT_CLASSES {
    ...
    "touch",
    "pen",
  };  ///< Stable streamed-input class names accepted during Eclipse pairing.
  ...
  /**
   * @brief Result of parsing optional Eclipse pairing policy fields.
   */
  ...
  /**
   * @brief Check whether a request explicitly opted into Eclipse API v1 fields.
   *
