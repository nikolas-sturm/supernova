/**
 * @file src/eclipse_events.h
 * @brief Thread-safe Eclipse V1 event replay hub.
 */
#pragma once
...
/**
 * @brief Eclipse V1 event publication and replay support.
 */
namespace eclipse_events {
   ...
   */
  struct event_t {
    std::string type;  ///< Required Eclipse event type.
  ...
  /**
   * @brief Determine whether a type belongs to the required Eclipse event vocabulary.
   *
