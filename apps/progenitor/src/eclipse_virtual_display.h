/**
 * @file src/eclipse_virtual_display.h
 * @brief Platform-independent Eclipse virtual display lifecycle management.
 */
#pragma once
...
/**
 * @brief Eclipse virtual display lifecycle services.
 */
namespace eclipse_virtual_display {
  /**
   ...
   * @return Eclipse JSON resource object.
   */
