/**
 * @file src/eclipse_assets.h
 * @brief Validated Eclipse catalog image asset metadata.
 */
#pragma once
...
/**
 * @brief Eclipse application asset inspection.
 */
namespace eclipse_assets {
  constexpr std::uintmax_t MAX_ASSET_BYTES = 8U * 1024U * 1024U;  ///< Largest asset accepted by Eclipse Catalog V2.
