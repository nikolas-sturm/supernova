/**
 * @file src/platform/windows/eclipse_display.h
 * @brief Windows display snapshot declarations for Eclipse APIs.
 */
#pragma once
...
namespace eclipse::windows::display {
  ...
  /**
   * @brief Exact display mode exposed to Eclipse serialization.
   */
  struct Mode {
  ...
  struct PlatformDetails {
    ...
    bool capture_eligible {};  ///< Whether Sunshine can resolve active DXGI output.
  ...
  struct Snapshot {
    ...
    bool capture_eligible {};  ///< Whether Sunshine can capture output.
    Kind kind {Kind::Unknown};  ///< OS-derived output classification.
  };
   ...
   * @return Eclipse display mode object.
   */
   ...
   * @return Eclipse physical display object.
   */
