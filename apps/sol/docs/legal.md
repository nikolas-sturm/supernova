...
> any legal questions or concerns about using Sol, we recommend consulting with a lawyer.

Sol is licensed under the GPL-3.0 license, which allows for free use and modification of the software.
The full text of the license can be reviewed [here](https://github.com/LizardByte/Sunshine/blob/master/LICENSE).

## Commercial Use
Sol can be used in commercial applications without any limitations. This means that businesses and organizations
can use Sol to create and sell products or services without needing to seek permission or pay a fee.

However, it is important to note that the GPL-3.0 license does not grant any rights to distribute or sell the encoders
contained within Sol. If you plan to sell access to Sol as part of their distribution, you are responsible
...
In summary, while Sol is free to use, it is the user's responsibility to ensure compliance with all applicable
licensing requirements when redistributing the software as part of a commercial offering. If you have any questions or
concerns about using Sol in a commercial setting, we recommend consulting with a lawyer.
