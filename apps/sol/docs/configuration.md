...
Sol will work with the default settings for most users. In some cases you may want to configure Sol further.

The default location for the configuration file is listed below. You can use another location if you
choose, by passing in the full configuration file path as the first argument when you start Sol.
...
| Windows | @code{}%ProgramFiles%\\Sol\\config@endcode |

Although it is recommended to use the configuration UI, it is possible manually configure Sol by
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The locale used for Sol's user interface.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Whether to be notified of new pre-release versions of Sol.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">It may be possible that you cannot send the Windows Key from Terra directly. In those cases it may be useful to
            make Sol think the Right Alt key is the Windows key.
            </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            When enabled, Sol will pass through high resolution scroll events from Terra clients.
            <br>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            When enabled, Sol will pass through native pen/touch events from Terra clients.
            <br>
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            **macOS:**
            <br>
            Sol can only access microphones on macOS due to system limitations.
            ...
            **Windows:**
            ...
            @code{}
            %ProgramFiles%\Sol\tools\audio-info.exe
            @endcode
    ...
    <tr>
        <td>Default</td>
        <td colspan="2">Sol will select the default audio device.</td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The audio device that's virtual, like Steam Streaming Speakers. This allows Sol to stream audio,
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            **FreeBSD/Linux + VA-API:**
            ...
            @endcode
            To be supported by Sol, it needs to have at the very minimum:
            ...
            **Windows:**
            ...
            Enter the following command in command prompt or PowerShell.
            @code{}
            %ProgramFiles%\Sol\tools\dxgi-info.exe
            @endcode
    ...
    <tr>
        <td>Default</td>
        <td colspan="2">Sol will select the default video card.</td>
    </tr>
    <tr>
        <td>Example (FreeBSD/Linux)</td>
        <td colspan="2">@code{}
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            **FreeBSD/Linux:**
            <br>
            During Sol startup, you should see the list of detected displays:
            @code{}
    ...
    <tr>
        <td>Default</td>
        <td colspan="2">Sol will select the default display.</td>
    </tr>
    <tr>
        <td>Example (FreeBSD/Linux)</td>
        <td colspan="2">@code{}
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            @note{"Optimize game settings" must be enabled in Terra for this option to work.}
            @note{Applies to Windows only.}
        </td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            When using virtual display device (SolVDD) for streaming, it might incorrectly display HDR color. Sol can try to mitigate this issue, by turning HDR off and then on again.<br>
            If the value is set to 0, the workaround is disabled (default). If the value is between 0 and 3000 milliseconds, Sol will turn off HDR, wait for the specified amount of time and then turn HDR on again. The recommended delay time is around 500 milliseconds in most cases.<br>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The maximum bitrate (in Kbps) that Sol will encode the stream at. If set to 0, it will always use the bitrate requested by Terra.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Sol tries to save bandwidth when content on screen is static or a low framerate. Because many clients expect a constant stream of video frames, a certain amount of duplicate frames are sent when this happens. This setting controls the lowest effective framerate a stream can reach.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Sol will attempt to open ports for streaming over the internet.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Set the address family that Sol will use.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Set the IP address to bind Sol to. This is useful when you have multiple network interfaces
            and want to restrict Sol to a specific one. If not set, Sol will bind to all available
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Set the family of ports used by Sol.
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            If no external IP address is given, Sol will attempt to automatically detect external ip-address.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            How long to wait, in milliseconds, for data from Terra before shutting down the stream.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The path where the current Sol log is stored. Each time Sol starts, up to five previous
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The private key used for the web UI and Terra client pairing. For best compatibility,
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The certificate used for the web UI and Terra client pairing. For best compatibility,
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            The file where current state of Sol is stored.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    ...
    <tr>
        ...
        <td colspan="2">Automatic.
            Sol will use the first capture method available in the order of the table above.</td>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan="2">@code{}
    ...
    <tr>
        <td>kms</td>
        <td>DRM/KMS screen capture from the kernel. This requires that Sol has `cap_sys_admin` capability.
            @note{Applies to Linux only.}</td>
    </tr>
    <tr>
        <td>kwin</td>
    ...
    <tr>
        ...
        <td>(beta feature) Use Windows.Graphics.Capture to capture the display.
            @note{Applies to Windows only.}
            @attention{This capture method is not compatible with the Sol service.}</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Default</td>
        <td colspan="2">Sol will use the first encoder that is available.</td>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan="2">@code{}
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            By default Sol uses single-frame VBV/HRD, which means any encoded video frame size is not expected to
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            so Sol requests high power mode explicitly.
            @note{This option only applies when using NVENC [encoder](#encoder).}
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Sol can't capture fullscreen OpenGL and Vulkan programs at full frame rate unless they present on
            top of DXGI. With this option enabled Sol changes global Vulkan/OpenGL present method to
            "Prefer layered on DXGI Swapchain". This is system-wide setting that is reverted on Sol program exit.
            @note{This option only applies when using NVENC [encoder](#encoder).}
            @note{Applies to Windows only.}
        </td>
    </tr>
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            control for capping oversized encoded frames that would otherwise exceed Sol's
