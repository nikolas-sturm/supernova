/**
 * @file Form field components for Sol's stringly-typed config values.
 */
 ...
 *
 * Accepts booleans, 0/1, and the string pairs used by Sol config values
...
/**
 * @brief Checkbox bound to Sol's stringly-typed boolean config values.
