/**
 * @file Typed endpoint functions for every Sol web API route.
 *
...
/**
 * @brief Fetches the full Sol configuration.
 * @returns Parsed configuration object.
 */
export async function getConfig(): Promise<SolConfig> {
