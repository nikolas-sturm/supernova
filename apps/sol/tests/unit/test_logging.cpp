...
namespace {
  ...
  constexpr auto log_file = "test_sol.log";
...
protected:
  ...
  const std::filesystem::path test_directory {std::filesystem::path {SOL_TEST_BIN_DIR} / "log_rotation_tests"};  ///< Directory containing log rotation test files.
