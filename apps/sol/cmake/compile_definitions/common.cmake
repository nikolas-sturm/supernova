...
list(APPEND SOL_COMPILE_OPTIONS -Wall -Wno-sign-compare)
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 12)
        list(APPEND SOL_COMPILE_OPTIONS -Wno-maybe-uninitialized)
        ...
        if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 13)
            list(APPEND SOL_COMPILE_OPTIONS -Wno-restrict)
        endif()
    endif()

    # GCC 15 will complain about uninitialized variables in some cases (Simple-Web-Server)
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 15)
        list(APPEND SOL_COMPILE_OPTIONS -Wno-uninitialized)
    endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "^(Apple)?Clang$")
    ...
    if(APPLE OR CMAKE_SYSTEM_NAME STREQUAL "FreeBSD")
        list(APPEND SOL_COMPILE_OPTIONS -fexperimental-library)
        list(APPEND SOL_LINK_OPTIONS -fexperimental-library)
    endif()
endif()
if(BUILD_WERROR)
    list(APPEND SOL_COMPILE_OPTIONS -Werror)
endif()

# setup assets directory
if(NOT SOL_ASSETS_DIR)
    set(SOL_ASSETS_DIR "assets")
endif()
...
list(APPEND SOL_EXTERNAL_LIBRARIES libvirtualhid::libvirtualhid)
...
set(SOL_TARGET_FILES
        ...
        "${CMAKE_SOURCE_DIR}/src/terra_api.h"
        "${CMAKE_SOURCE_DIR}/src/terra_assets.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_assets.h"
        "${CMAKE_SOURCE_DIR}/src/terra_events.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_events.h"
        "${CMAKE_SOURCE_DIR}/src/terra_operations.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_operations.h"
        "${CMAKE_SOURCE_DIR}/src/terra_peripherals.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_peripherals.h"
        "${CMAKE_SOURCE_DIR}/src/terra_profiles.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_profiles.h"
        "${CMAKE_SOURCE_DIR}/src/terra_sandboxes.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_sandboxes.h"
        "${CMAKE_SOURCE_DIR}/src/terra_virtual_display.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_virtual_display.h"
        "${CMAKE_SOURCE_DIR}/src/terra_workspaces.cpp"
        "${CMAKE_SOURCE_DIR}/src/terra_workspaces.h"
...
if(NOT SOL_ASSETS_DIR_DEF)
    set(SOL_ASSETS_DIR_DEF "${SOL_ASSETS_DIR}")
endif()
list(APPEND SOL_DEFINITIONS SOL_ASSETS_DIR="${SOL_ASSETS_DIR_DEF}")

# Publisher metadata
list(APPEND SOL_DEFINITIONS SOL_PUBLISHER_NAME="${SOL_PUBLISHER_NAME}")
list(APPEND SOL_DEFINITIONS SOL_PUBLISHER_WEBSITE="${SOL_PUBLISHER_WEBSITE}")
list(APPEND SOL_DEFINITIONS SOL_PUBLISHER_ISSUE_URL="${SOL_PUBLISHER_ISSUE_URL}")
...
# tray icon
if(SOL_ENABLE_TRAY)
    list(APPEND SOL_EXTERNAL_LIBRARIES tray::tray)
else()
    set(SOL_TRAY 0)
    message(STATUS "Tray icon disabled")
endif()
list(APPEND SOL_DEFINITIONS SOL_TRAY=${SOL_TRAY})
