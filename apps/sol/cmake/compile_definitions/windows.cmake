...
add_compile_definitions(SOL_PLATFORM="windows")
...
list(APPEND SOL_COMPILE_OPTIONS -Wno-misleading-indentation)

# Disable warnings for Windows ARM64
if(CMAKE_SYSTEM_PROCESSOR MATCHES "ARM64")
    list(APPEND SOL_COMPILE_OPTIONS -Wno-dll-attribute-on-redeclaration)  # Boost
    list(APPEND SOL_COMPILE_OPTIONS -Wno-unknown-warning-option)  # ViGEmClient
    list(APPEND SOL_COMPILE_OPTIONS -Wno-unused-variable)  # Boost
    ...
    if(SOL_USE_STATIC_QT AND CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        list(APPEND SOL_LINK_OPTIONS -Wl,--allow-multiple-definition)
    endif()
endif()
...
# sol icon
if(NOT DEFINED SOL_ICON_PATH)
    set(SOL_ICON_PATH "${CMAKE_SOURCE_DIR}/sol.ico")
endif()

# Create a separate object library for the RC file with minimal includes
add_library(sol_rc_object OBJECT "${CMAKE_SOURCE_DIR}/src/platform/windows/windows.rc")
...
set_target_properties(sol_rc_object PROPERTIES
    COMPILE_DEFINITIONS "PROJECT_ICON_PATH=${SOL_ICON_PATH};PROJECT_NAME=${PROJECT_NAME};PROJECT_VENDOR=${SOL_PUBLISHER_NAME};PROJECT_VERSION=${PROJECT_VERSION};PROJECT_VERSION_MAJOR=${PROJECT_VERSION_MAJOR};PROJECT_VERSION_MINOR=${PROJECT_VERSION_MINOR};PROJECT_VERSION_PATCH=${PROJECT_VERSION_PATCH};RC_VERSION_BUILD=${RC_VERSION_BUILD};RC_VERSION_REVISION=${RC_VERSION_REVISION}"  # cmake-lint: disable=C0301
    INCLUDE_DIRECTORIES ""
)
...
set(PLATFORM_TARGET_FILES
        ...
        "${CMAKE_SOURCE_DIR}/src/platform/windows/terra_display.cpp"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/terra_display.h"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/terra_sandbox_provider.cpp"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/terra_sandbox_provider.h"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/terra_virtual_display_provider.cpp"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/terra_virtual_display_provider.h"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/sol_vdd.cpp"
        "${CMAKE_SOURCE_DIR}/src/platform/windows/sol_vdd.h"
