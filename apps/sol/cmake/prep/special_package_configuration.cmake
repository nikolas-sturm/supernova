...
elseif(UNIX)
    ...
    if(${SOL_CONFIGURE_PKGBUILD})
        configure_file(packaging/linux/Arch/PKGBUILD PKGBUILD @ONLY)
        configure_file(packaging/linux/Arch/sol.install sol.install @ONLY)
    endif()

    # configure the flatpak manifest
    if(${SOL_CONFIGURE_FLATPAK_MAN})
...
if(${SOL_CONFIGURE_ONLY})
    # message
    message(STATUS "SOL_CONFIGURE_ONLY: ON, exiting...")
    set(END_BUILD ON)
else()
    set(END_BUILD OFF)
endif()
