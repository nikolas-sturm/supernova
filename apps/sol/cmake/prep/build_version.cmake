...
if((DEFINED ENV{BRANCH}) AND (DEFINED ENV{BUILD_VERSION}))  # cmake-lint: disable=W0106
    ...
    # Generate Sol Version based of the git tag
...
list(APPEND SOL_DEFINITIONS PROJECT_FQDN="${PROJECT_FQDN}")
list(APPEND SOL_DEFINITIONS PROJECT_NAME="${PROJECT_NAME}")
list(APPEND SOL_DEFINITIONS PROJECT_VERSION="${PROJECT_VERSION}")
list(APPEND SOL_DEFINITIONS PROJECT_VERSION_MAJOR="${PROJECT_VERSION_MAJOR}")
list(APPEND SOL_DEFINITIONS PROJECT_VERSION_MINOR="${PROJECT_VERSION_MINOR}")
list(APPEND SOL_DEFINITIONS PROJECT_VERSION_PATCH="${PROJECT_VERSION_PATCH}")
list(APPEND SOL_DEFINITIONS PROJECT_VERSION_COMMIT="${GITHUB_COMMIT}")
