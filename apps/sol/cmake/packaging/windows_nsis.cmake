...
SET(CPACK_NSIS_EXTRA_INSTALL_COMMANDS
        ...
        nsExec::ExecToLog \
          ...
          -File \\\"$INSTDIR\\\\scripts\\\\sol-setup.ps1\\\" -Action install'
        Goto +2
        nsExec::ExecToLog \
          'powershell -ExecutionPolicy Bypass \
          -File \\\"$INSTDIR\\\\scripts\\\\sol-setup.ps1\\\" -Action install -Silent'
        install_done:
        ")
...
set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS
        ...
        nsExec::ExecToLog \
          'powershell -ExecutionPolicy Bypass \
          -File \\\"$INSTDIR\\\\scripts\\\\sol-setup.ps1\\\" -Action uninstall'
...
set(CPACK_NSIS_MENU_LINKS
        "https://docs.lizardbyte.dev/projects/sunshine" "Sol documentation"
