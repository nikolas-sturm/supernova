...
namespace proc {
  ...
  struct ctx_t {
    ...
    std::string uuid;  ///< Stable Terra application UUID.
    nlohmann::json terra_metadata;  ///< Versioned metadata read from the application's `x-eclipse` object.
    ...
    bool wait_all;  ///< Whether Sol waits for all child processes.
  ...
  public:
    ...
    /**
     * @brief Find an application by its stable Terra UUID.
     *
     * @param uuid Stable Terra application UUID.
