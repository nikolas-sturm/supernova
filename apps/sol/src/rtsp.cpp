...
#pragma pack(pop)
  ...
  public:
     ...
     *
     * @return One snapshot per logical Terra session.
     */
  ...
  void start() {
    ...
    boost::system::error_code ec;
    if (server.bind(net::af_from_enum_string(config::sol.address_family), net::map_port(rtsp_stream::RTSP_SETUP_PORT), ec)) {
