...
namespace util {
  ...
  /**
   * @brief Compare two Sol unique pointers by their stored addresses.
   *
  ...
  /**
   * @brief Compare a standard unique pointer with a Sol unique pointer.
   *
   * @param x Left-hand pointer or value being compared.
   * @param y Right-hand pointer or value being compared.
   * @return True when both wrappers store the same pointer address.
  ...
  /**
   * @brief Compare a Sol unique pointer with a standard unique pointer.
   *
   * @param x Left-hand pointer or value being compared.
   * @param y Right-hand pointer or value being compared.
   * @return True when both wrappers store the same pointer address.
  ...
  /**
   * @brief Compare a Sol unique pointer with null.
   *
   * @param x Left-hand pointer or value being compared.
  ...
  /**
   * @brief Compare null with a Sol unique pointer.
   *
   * @param y Right-hand pointer or value being compared.
   * @return True when the wrapper does not own a pointer.
   */
