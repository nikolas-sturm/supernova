...
namespace video {
  ...
  /**
   * @brief Map an FFmpeg hardware device type to Sol's memory type.
   *
   * @param type FFmpeg hardware device type reported by the encoder backend.
   * @return Sol memory type used by the capture and encode pipeline.
   */
  platf::mem_type_e map_base_dev_type(AVHWDeviceType type);
  /**
   * @brief Map an FFmpeg pixel format to Sol's pixel format enum.
   *
   * @param fmt FFmpeg pixel format to convert.
   * @return Sol pixel format used by display and encoder backends.
   */
  ...
  /**
   * @brief Encoder name and feature flags advertised by Sol.
   */
  struct encoder_t {
...
#undef _CONVERT
  ...
  struct packet_raw_avcodec: packet_raw_t {
    ...
    /**
     * @brief Return the FFmpeg packet PTS used as Sol's frame index.
     *
     * @return Monotonic frame index assigned to this frame.
     */
  ...
  struct packet_raw_generic: packet_raw_t {
    /**
     * @brief Wrap generic encoded frame bytes in Sol packet metadata.
     *
