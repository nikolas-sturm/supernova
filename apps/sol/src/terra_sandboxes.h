/**
 * @file src/terra_sandboxes.h
 * @brief Standalone Terra sandbox policy and lifecycle core.
 */
#pragma once
...
/**
 * @brief Terra sandbox policy validation and lifecycle management.
 */
namespace terra_sandboxes {
  /**
   ...
   * @return Terra sandbox JSON object.
   */
