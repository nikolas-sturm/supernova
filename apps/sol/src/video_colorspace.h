...
namespace video {
  ...
  /**
   * @brief Sol colorimetry values derived from stream configuration.
   */
  struct sol_colorspace_t {
  ...
  /**
   * @brief Derive Sol colorspace metadata from the negotiated client config.
   *
  ...
  /**
   * @brief Pair of Sol and AVCodec colorimetry descriptions.
   */
