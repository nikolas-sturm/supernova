...
namespace platf::virtualhid {
   ...
   * @param id Sol gamepad identifiers.
   ...
   *
   * @param context Input context.
   * @param id Sol gamepad identifiers for the resumed client.
   ...
   *
   * @param context Input context.
   * @param battery Sol battery event.
   */
