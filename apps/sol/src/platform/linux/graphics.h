...
/**
 * @def SOL_STRINGIFY_HELPER(x)
 * @brief Macro for SOL STRINGIFY HELPER.
 */
#define SOL_STRINGIFY_HELPER(x) #x
/**
 * @def SOL_STRINGIFY(x)
 * @brief Macro for SOL STRINGIFY.
 */
#define SOL_STRINGIFY(x) SOL_STRINGIFY_HELPER(x)
/**
 ...
 */
#define gl_drain_errors gl_drain_errors_helper(__FILE__ ":" SOL_STRINGIFY(__LINE__))
...
namespace egl {
  ...
  public:
     ...
     * @param is_yuv444 Is YUV444.
     */
    void apply_colorspace(const video::sol_colorspace_t &colorspace, bool is_yuv444);
