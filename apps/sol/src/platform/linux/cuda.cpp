...
/**
 * @def SOL_STRINGVIEW_HELPER(x)
 * @brief Macro for SOL STRINGVIEW HELPER.
 */
#define SOL_STRINGVIEW_HELPER(x) x##sv
/**
 * @def SOL_STRINGVIEW(x)
 * @brief Macro for SOL STRINGVIEW.
 */
#define SOL_STRINGVIEW(x) SOL_STRINGVIEW_HELPER(x)
...
namespace cuda {
  ...
  /**
   * @brief Convert a CUDA result code into Sol's capture status.
   *
