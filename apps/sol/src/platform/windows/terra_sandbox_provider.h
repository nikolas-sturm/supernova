/**
 * @file src/platform/windows/terra_sandbox_provider.h
...
namespace terra::windows::sandbox {
   ...
   */
  using application_resolver_t = std::function<std::optional<terra_sandboxes::application_t>(const std::string &, const std::optional<std::string> &)>;
   ...
   * @return Callbacks suitable for `terra_sandboxes::manager_t`.
   */
  [[nodiscard]] terra_sandboxes::callbacks_t make_callbacks(configuration_t configuration);
}  // namespace terra::windows::sandbox
