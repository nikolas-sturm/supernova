...
#define APPLY_CALIBRATION(val, bias, scale) (int32_t) (((float) (val) + (bias)) / (scale))
  ...
  /**
   * @brief Update an X360 report from Sol gamepad state.
   * @param gamepad The gamepad to update.
   * @param gamepad_state The gamepad button/axis state sent from the client.
   */
  ...
  /**
   * @brief Update a DS4 report from Sol gamepad state.
   * @param gamepad The gamepad to update.
   * @param gamepad_state The gamepad button/axis state sent from the client.
   */
  ...
  /**
   * @brief Submit updated Sol gamepad state to the virtual device.
