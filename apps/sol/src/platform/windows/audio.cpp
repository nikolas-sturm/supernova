...
namespace platf::audio {
  ...
  public:
     ...
     * @return S_OK because Sol does not act on this notification.
     */
  ...
  public:
    ...
    std::string assigned_sink;  ///< Sink assigned while Sol captures host audio, captured directly by the microphone.
  };
